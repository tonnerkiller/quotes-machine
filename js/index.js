/*
  ...
  document ready
    call getJSON to set initial site
    append getJSON to New Quote button
*/
...
$("document").ready(function(){
  ...
  $("#tweetbutton").on('click',function(){window.open("https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp"+encodeURIComponent(", author of quotes app challange")+quoteSingleton.twitter+encodeURIComponent(", author of API used")+",tonkllr"+encodeURIComponent(", author of Quotes Machine App")+"&text="+quoteSingleton.getText()+" - "+quoteSingleton.getAuthor())});
  $("#hubbutton").on('click', function(){
                     ...
                     var x = window.open("https://"+fullchannel[1]+"/rpost?&body="+quote+"&title=News from the Quotes Machine&channel="+fullchannel[0]);
                    
  //need to forward to actual message or close window
  });
  /*$("#gnubutton").on('click',function(){
    var instance="gnusocial.de";
    var username="tonnerkiller";
    window.open("https://"+instance+"/api/statuses/update.xml?f=&text="+quote);
  });*/
